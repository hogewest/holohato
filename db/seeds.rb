...
CHANNELS = {
  ...
  'UC1opHUrw8rvnsadT-iGp7Cg' => { 'title' => 'Aqua Ch. 湊あくあ', 'description' => '湊あくあ' },
  'UCXTpFs_3PqI41qX2d9tL2Rw' => { 'title' => 'Shion Ch. 紫咲シオン', 'description' => '紫咲シオン' },
  ...
  'UCIBY1ollUsauvVi4hW4cumw' => { 'title' => 'Chloe ch. 沙花叉クロヱ - holoX -', 'description' => '沙花叉クロヱ' },
